...
from 1 to 6. n of the observations went missing, and you only have the observations of m rolls. 
...
Return an array of length n containing the missing observations such 
that the average value of the n + m rolls is exactly mean. 
