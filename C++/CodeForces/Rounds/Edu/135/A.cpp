...
There are cnti balls of color i in the bag. The total amount of balls in the bag is odd 
...
In the third testcase, you can keep removing one ball of color 1 and one ball of color 2 
until there are no more balls of color 1. At the end, three balls of color 2 remain.
*/
