...
reaches the student number n - 1. After that, the teacher will restart the process, starting with 
...
that problem. However, if the current number of chalk pieces is strictly less than chalk[i], then the student 
