...
Certain functions associated with the vector are:
	...
	Iterators
    	...
    	cend() –
    		...
    		Returns a constant iterator pointing to the theoretical element that follows
    	...
    	crbegin() –
    		...
    		Returns a constant reverse iterator pointing to the last element in the vector (reverse beginning).
    	...
    	crend() –
    		...
    		Returns a constant reverse iterator pointing to the theoretical element preceding
...
Modifiers:
    ...
    swap() –
    	...
    	It is used to swap the contents of one vector with another vector of same type.
    ...
    emplace_back() –
    	...
    	It is used to insert a new element into the vector container,
